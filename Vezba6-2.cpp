...
compNum = 1 + rand() %6;
compNum2 = 1 + rand() %6;
// se generira slucaen broj od 1 do 6
...
six();
break;
default: // ako brojot ne e pomegju 1 i 6 togas se koristi default i se ispisuva "Error"
cout << "Error...";
break;
} //end switch
...
// pause go pauzira izvrsuvanjeto na programata dodeka korisnikot ne pritisne na tastaturata, a cls ja brise sodrzinata od ekranot
